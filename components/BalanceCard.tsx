      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-8">
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="text-white/90 text-sm font-semibold uppercase tracking-widest mb-2" style={{ fontFamily: 'var(--font-kanit)' }}>Total Balance</p>
              <h2 className="text-6xl font-bold mt-1 tracking-tight text-white" style={{ fontFamily: 'var(--font-kanit)' }}>
